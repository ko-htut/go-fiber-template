# Fiber backend template for [Create Go App CLI and Modified](https://github.com/create-go-app/cli)

<img src="https://img.shields.io/badge/Go-1.18+-00ADD8?style=for-the-badge&logo=go" alt="go version" />&nbsp;<a href="https://goreportcard.com/report/github.com/hotrungnhan/go-fiber-template" target="_blank"><img src="https://img.shields.io/badge/Go_report-A+-success?style=for-the-badge&logo=none" alt="go report" /></a>&nbsp;<img src="https://img.shields.io/badge/license-Apache_2.0-red?style=for-the-badge&logo=none" alt="license" />
...
| Name                                                                  | Version    | Type       |
| --------------------------------------------------------------------- | ---------- | ---------- |
| [gofiber/fiber](https://github.com/gofiber/fiber)                     | `v2.34.1`  | core       |
...
| [stretchr/testify](https://github.com/stretchr/testify)               | `v1.7.5`   | tests      |
| [golang-jwt/jwt](github.com/golang-jwt/jwt/v4)                        | `v4.4.2`   | auth       |
| [spf13/viper](https://github.com/spf13/viper)                         | `v1.4.0`   | config     |
| [go-gorm/gorm](https://github.com/go-gorm/gorm)                       | `v1.3.5`   | database   |
| [go-redis/redis](https://github.com/go-redis/redis)                   | `v8.11.5`  | cache      |
| [swaggo/swag](https://github.com/swaggo/swag)                         | `v1.8.3`   | utils      |
...
| [creasty/defaults](https://github.com/creasty/defaults)               | `v1.6.0`   | utils      |
| [uber-go/zap](https://github.com/uber-go/zap)                         | `v1.21.0`  | logger     |
